...
int main() {
    ...
    uint32_t polynomialDegree = 1006;
    ...
    std::vector<double> coeffsHtan = EvalChebyshevCoefficients(
        derivativeHtanFunc, -0.5, 0.5, 1006
    );
    ...
    std::vector<double> coeffsTanh = EvalChebyshevCoefficients(
...
// Overall start time
    ...
    auto transformedValue1 = DEP1(2.55, 0.5, 3, squareInverse, cryptoContext);
...
// Time for EvenChebyshevPS inverse: 37.6796 s
// Time for rotation loop: 1.35995 s
// Time for first DEP1 transformation: 2.52398 s
// Time for final EvenChebyshevPS: 12.7286 s
// Overall execution time: 54.2922 s  (total depth required = 40)
// Original Values (first 15): [ 0 0 0 0 0 0 0 1 2 3 500 2048 2048 2048 2048 ]
// Decrypted-transformed Results (first 15): [ 1 0.00112799 2.79505e-09 2.0156e-09 
// 1.31974e-10 2.43015e-09 -1.06796e-09 -4.01577e-10 -2.19937e-09 5.17996e-07 1.55025e-09 
// 1.53874e-09 1.52249e-09 1.5616e-09 1.58954e-09 ]